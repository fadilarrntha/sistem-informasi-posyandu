...
class Laporan_Anak extends CI_Controller
{
    ...
    {
        $data['title'] = 'Laporan Anak | Posyandu Paleto Indah';
    ...
    function Cetak_Laporan()
    {
        ...
        // die;
            ...
            foreach ($dt as $rows) {
                $html = $html . "<tr>";
                $html = $html . "<td align='center'>" . date_format(date_create($rows->tgl_skrng), "j F Y") . "</td><td align='center'>" . $rows->usia . ' bulan' . "</td><td align='center'>" . $rows->bb . ' kg' . "</td><td align='center'>" . $rows->tb . ' cm' . "</td><td align='center'>" . $rows->imunisasi . "</td><td align='center'>" . $rows->vit_a . "</td><td align='center'>" . $rows->ket . "</td>";
                $html = $html . "</tr>";
            }
            $html = $html . "</tbody>";
            $html = $html . "</table>";
