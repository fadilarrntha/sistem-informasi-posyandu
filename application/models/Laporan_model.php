...
class Laporan_model extends CI_Model
{
    ...
    function get($where = array())
    {
        ...
        $this->db->select('i.nik_anak, h.tgl_lahir, h.tgl_skrng, h.usia, h.bb, h.tb, h.bb, q.imunisasi, q.vit_a, q.ket, p.id_ibu, p.nama_ibu, p.nama_suami, p.alamat, i.nama_anak')
            ->from('penimbangan h')
