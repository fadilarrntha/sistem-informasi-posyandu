    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url('user/ubah_profile'); ?>" method="POST" enctype="multipart/form-data">
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="username">Username <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6">
                                <input type="hidden" id="id_users" name="id_users" class="form-control" value="<?= $user['id_users']; ?>">
                        ...
                        <div class="item form-group">
                            <div class="col-md-6 col-sm-6">
                                <input id="current-password" class="form-control" type="hidden" name="current-password">
                            </div>
                        </div>
                        <div class="item form-group">
                        ...
                        <div class="item form-group">
                            <div class="col-md-6 col-sm-6">
                                <input id="repeat-password" class="form-control" type="hidden" name="repeat-password">
                            </div>
                        </div>
