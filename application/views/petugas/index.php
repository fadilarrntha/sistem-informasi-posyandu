<div class="right_col" role="main">
    ...
    foreach ($petugas as $row) {
        $a++;
    ?>
        <div class="modal fade bs-example-modal-lg" id="viewDataPetugasModal<?= $row['id_petugas']; ?>"" tabindex=" -1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">

                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">Data Petugas</h4>
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
                        </button>
                    </div>
                    <form id="demo-form2" action="<?php echo base_url('petugas/updateDataPetugas/') . $row['id_petugas']; ?>" class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 form-group">
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="nama-petugas">Nama Petugas</label>
                                        <div class="col-md-9">
                                            <input type="text" id="nama-petugas" name="nama-petugas" required="required" class="form-control" value="<?= $row['nama_petugas'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="tmt-lahir">tempat Lahir</label>
                                        <div class="col-md-9">
                                            <input type="text" id="tmt-lahir" name="tmt-lahir" class="form-control" value="<?= $row['tempat_lahir'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align">Tgl Lahir
                                        ...
                                        <div class="col-md-9">
                                            <input id="tgl-lahir" name="tgl-lahir" class="date-picker form-control" placeholder="dd-mm-yyyy" type="text" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)" value="<?= $row['tgl_lahir'] ?>" readonly>
                                            <script>
                                                function timeFunctionLong(input) {
                                                    setTimeout(function() {
                                                        input.type = 'text';
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="no-hp">No HP</label>
                                        <div class="col-md-9">
                                            <input type="text" id="no-hp" name="no-hp" class="form-control" data-inputmask="'mask' : '9999-9999-9999'" value="<?= $row['no_hp'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="jabatan">Jabatan</label>
                                        <div class="col-md-9">
                                            <input type="text" id="jabatan" name="jabatan" class="form-control" value="<?= $row['jabatan'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="pendidikan-terakhir">Pendidikan Terakhir</label>
                                        <div class="col-md-9">
                                            <input type="text" id="pendidikan-terakhir" name="pendidikan-terakhir" class="form-control" value="<?= $row['pendidikan_terakhir'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="lama-kerja">Lama Kerja</label>
                                        <div class="col-md-8">
                                            <input type="number" id="lama-kerja" name="lama-kerja" class="form-control" value="<?= $row['lama_kerja'] ?>" readonly>
                                        </div>
                                        <label class="col-form-label label-align" for="tahun">Tahun
                                    </div>
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="tugas-pokok">Tugas Pokok</label>
                                        <div class="col-md-9">
                                            <input type="text" id="tugas-pokok" name="tugas-pokok" class="form-control" value="<?= $row['tugas_pokok'] ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
